...
### Notes
Set up the UI layout to display notes, a basic preview & description. The user is able to create and edit notes. Unfortunately, the user is still not able to save the notes. Next step is to allow the user to save and delete notes. The next step is to finish editing functionality and modify the aesthetics. 
